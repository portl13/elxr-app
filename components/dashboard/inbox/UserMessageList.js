  ...
  return (
    <>
        ...
        <div className="thread-participants">
          ...
          <div className="thread-date">
            {!messages?.length || userMsg?.isNewUser
              ...
              : 'Started'}{' '}
            {userMsg?.date && !userMsg?.isNewUser && getDate(userMsg?.date)}
          </div>
        </div>
          ...
          {isOpen && (
            <div className="actions-container">
              <ul>
                ...
                >
                  <FontAwesomeIcon icon={faTimesCircle} /> Hide conversation
                </li>
                ...
                <li onClick={() => setDeleteModal(true)}>
                  <FontAwesomeIcon icon={faTrash} /> Delete your messages
                </li>
      ...
      <div className="message-thread-list">
        {!userMsg?.isNewUser &&
          userMsg?.messages?.map((ele) => {
            const recipients = userMsg?.recipients[ele.sender_id]
            return (
              <div key={ele.id} className="main-box-panel">
                <div className="bp-avatar-wrap">
                  <img
                    src={userMsg?.recipients[ele.sender_id].user_avatars.full}
                  />
                </div>
