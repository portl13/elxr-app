...
import CommentRplL3Card from "./CommentRplL3Card";
import DeleteModal from "./DeleteModal";
import Link from "next/link";
import { getProfileRoute } from "../../utils/constant";
function CommentRplL2Card({
  comment,
  reply,
  deleteComment,
  report,
  ...
  return (
    <>
      <div className="activity-comments-container live-activity-container pleft65">
...
export default CommentRplL2Card;
