...
import CommentRplL4Card from "./CommentRplL4Card";
import DeleteModal from "./DeleteModal";
import Link from "next/link";
import { getProfileRoute } from "../../utils/constant";
function CommentRplL3Card({
  comment,
  reply,
  deleteComment,
  report,
  ...
  return (
    <>
      <div className="activity-comments-container live-activity-container pleft85">
...
export default CommentRplL3Card;
