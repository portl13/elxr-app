    ...
    <>
      <div className="itemBody">
        <div className="item-body-inner">
            ...
            <ul>
              <li className={tab === 'products' && 'active'}>
                <Button type="button" onClick={() => setTab('products')}>
                  {' '}
                  {channelAbout?.store_tab_headings.products}
                </Button>
              </li>
              <li className={tab === 'about' && 'active'}>
                <Button type="button" onClick={() => setTab('about')}>
                  {' '}
                  {channelAbout?.store_tab_headings.about}
                </Button>
              </li>
              <li className={tab === 'policies' && 'active'}>
                <Button type="button" onClick={() => setTab('policies')}>
                  {channelAbout?.store_tab_headings.policies}
                </Button>
              </li>
                ...
                <Button type="button" onClick={() => setTab('followers')}>
                  ...
                  <span
                    dangerouslySetInnerHTML={{
                      __html: channelAbout?.store_tab_headings.followers,
                    }}
                  ></span>{' '}
                </Button>
              </li>
          ...
          {tab === 'about' && channelAbout && (
            <AboutCard channelAbout={channelAbout} />
          )}
          {tab === 'policies' && channelPolicy && (
            <PolicyCard channelPolicy={channelPolicy} />
          )}
          {tab === 'followers' && channelFollowers && (
            <Follower channelFollowers={channelFollowers} />
          )}
        </div>
      </div>
    </>
