...
import { getCustomerDetails, getOrderDetails, getOrdersById } from "../../pages/api/channel.api";
            ...
            <div className="wcfm-collapse-content">
                <div className="wcfm-top-element-container justify-between">
                    ...
                    <div className="select-tag">
                        <select>
                            <option>{customerDetails?.first_name} {customerDetails?.last_name}</option>
                        </select>
                    </div>
                    <div className="right-container">
                        <div className="new-tag-panel">
                            <button type="button" className="btn btn-secondary"><FontAwesomeIcon icon={faUserPlus} />Add New</button>
                        </div>
                    ...
                    <div className="overview-section">
                        <div className="overview-panel">
                            ...
                            <div className="right-panel">
                                <div className="input-section">{customerDetails?.user_email}</div>
                            </div>
                        </div>
                        <div className="overview-panel">
                            <div className="left-panel">First Name</div>
                            <div className="right-panel">
                                <div className="input-section">{customerDetails?.first_name}</div>
                            </div>
                        </div>
                        <div className="overview-panel">
                            <div className="left-panel">Last Name</div>
                            <div className="right-panel">
                                <div className="input-section">{customerDetails?.last_name}</div>
                            </div>
                        </div>
                        <div className="overview-panel">
                ...
                <h4><FontAwesomeIcon icon={faCartPlus} />Orders</h4>
                <div className="billing-wrapper">
