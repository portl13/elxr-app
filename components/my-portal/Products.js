...
export default function Products({ user, handleRedirect, id, open, setOpen }) {
  ...
  return (
    <section css={wcfmStyle}>
      <div className="wcfm-collapse-content">
        <div className="wcfm-top-element-container pl-0 align-items-center">
          <h4 className="text-uppercase text-primary channel-title p-0">
            Product Manager
          </h4>
          <span
        ...
        <div className="wcfm-top-element-container">
          <ul className="wcfm_products_menus">
            <li className={id === 'any' ? 'active' : ''}>
              ...
              >
                All{' '}
                {count !== null && id === 'any' && count !== 0 && `(${count})`}
              </Button>
            </li>
