        ...
        <>
            <Row>
                <Col className="d-flex justify-content-center align-items-center" xs="4" >
                    ...
                    <ProfileAvatarWrapper className="text-center text-sm-left">
                        <img
                            ...
                            src={userProfile ? userProfile.avatar_urls.full || userProfile.avatar_urls.thumb : "/img/avatar.jpg"}
                            alt="username" />
                ...
                <Col xs="8">
                    <div className="d-flex justify-content-center mb-sm-3">
                        <ProfileDataCounter>
                            <span className="count">{userProfile ? userProfile.followers : 0}</span>
                            <span className="tilte">Followers</span>
                        </ProfileDataCounter>
                        <ProfileDataCounter>
                            <span className="count">{userProfile ? userProfile.following : 0}</span>
                    ...
                    <div className="my-2" xs="12" sm="8">
                        ...
                        <div className="d-flex justify-content-center mt-2 mt-sm-0">
                            <ProfileButtonAction onClick={()=> Router.push('/profile-edit?tab=profile-update')} className="btn btn-sm-block">
                                Edit
                            </ProfileButtonAction>
            ...
            <Row>
                <Col className="my-2" xs="12">
                    <h2
                        className="profile-title text-capitalize mt-2 mb-sm-0">
