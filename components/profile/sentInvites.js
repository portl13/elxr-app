...
export const SentInvites = () => {
  ...
  return (
    <>
      ...
      {data?.map((email) => (
          <div key={email.id} className="table-responsive-row px-3 d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-4 border-bottom">
