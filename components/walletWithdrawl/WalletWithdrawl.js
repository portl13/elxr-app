...
function WalletWithdrawl() {
  ...
  return (
    <div css={withdrawlStyle} className="wallet-data-wrapper">
      ...
      <div className=" d-flex mb-lg-4 px-md-4">
        <FontAwesomeIcon className="icon-setting" icon={faClipboard} />
        <div className="w-100 ml-lg-3 d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
          <span className="mb-2 font-size-14 ">
      ...
      <div className="withdraw-wrapper-div">
        ...
        <div className="view-wrapper-panel border-0 px-0 px-md-4 mt-4">
