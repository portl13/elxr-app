...
export const getEventList = (user, data) =>
...
export const getEventCategories = (user) =>
  axios.get(`${baseApi}categories?page=1&per_page=100&hide_empty=true`, {
    headers: {
      Authorization: `Bearer ${user?.token}`,
    },
  })
...
export const getArtistList = (data) =>
  axios.get(`${url}/api/v2/artists`, {
    params: data,
  })

export const getArtistDetails = (slug) =>
  axios.get(`${url}/api/v2/artist/detail/${slug}`)
