...
function EditAddress() {
  ...
  let stateName = State.getStatesOfCountry(country).filter(
    (st) => st.isoCode === state
  )
    ...
    <section css={woocommerceFieldsStyle}>
      ...
      <div className="woocommerce-account-fields row">
        ...
        <div className="col-12 mb-3">
          ...
          >
            <option key="UNIQUE-ID"  disabled="disabled">
              Select Country
            </option>
            {countryList.map((e) => (
        ...
        <div className="col-12 mb-3">
          ...
          <select value={state} onChange={(e) => setState(e.target.value)}>
            <option key="UNIQUE-ID-2"  disabled="disabled">
              Select State
            </option>
            {country &&
              states.map((e) => (
        ...
        <div className="col-checkbox-ui mb-3">
          <input type="checkbox" />
          <span>
            Update the Billing Address used for all of my active subscriptions
            (optional)
          </span>
        </div>
        {emailValid !== false && (
